...
/**
 * Classe CritereMotifMedical représentant la table critere de la base de
 * données
 */
public class CritereMotifMedical implements CritereInterface, Cloneable,
		Serializable {
	...
	private int id = 0;
	private final String typeCritere = "Motif médical";
	private final Comparateur comparateur = null;
	private Motif valeurComparee = null;

	public CritereMotifMedical() {
	}

	public CritereMotifMedical(int id) {
		this.id = id;
	}
	...
	public void setValeurComparee(String valeurComparee) {
		this.valeurComparee = Motif.valueOf(valeurComparee);
	}
	...
	public boolean controler(DossierIndemnisation dos) {
		return dos.getArretTravail().getMotifMedical() == this.valeurComparee;
	}
	...
	public boolean isEgal(CritereInterface objet) {
		...
		if (this.valeurComparee == null) {
			if (objet.getValeurComparee() != null)
				return (false);
		} else if (!this.valeurComparee.equals(Motif.valueOf(objet
				.getValeurComparee()))) {
			return (false);
		}
		return true;
	...
	public String toString() {
		return "Motif : " + this.valeurComparee.getNom();
	}
	 ...
	 */
	public Object copie() {
		CritereMotifMedical copie = new CritereMotifMedical();
		copie.setId(this.id);
		if (this.typeCritere != null)
